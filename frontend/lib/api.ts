...
export type EvidenceItem = { id: number; match_id: number; video_asset_id: number | null; timeline_event_id: number | null; evidence_type: EvidenceType; label: string; rugby_element: string | null; source_uri: string | null; timestamp_seconds: number | null; confidence_label: string | null; notes: string | null; approved_for_training: boolean; created_at: string; updated_at: string };
export type EvidenceItemPayload = Omit<EvidenceItem, "id" | "created_at" | "updated_at">;
